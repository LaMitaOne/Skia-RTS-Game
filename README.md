...
This is an alpha build. It's not perfect—god knows there might still be hidden bugs or visual quirks—but it is a fully working, highly feature-rich C&C clone that goes way beyond basic movement and shooting. If you ever wanted to make your own c&c, that's the easiest way possible. (1 file, 3k lines with lots comments) Enjoy! :D
